---
title: "Chroma — 面向AI应用的开源向量数据库"
sidebar_label: "Chroma"
description: "面向AI应用的开源向量数据库"
---
...
面向AI应用的开源向量数据库。存储向量嵌入和元数据，执行向量和全文搜索，按元数据过滤。拥有简单的四功能API。可从笔记本扩展到生产集群。适用于语义搜索、RAG应用或文档检索。尤其适合本地开发和开源项目。
...
| 操作 | 延迟 | 备注 |
|-----------|---------|-------|
| 添加100个文档 | ~1-3秒 | 包含嵌入计算 |
| 查询（前10名） | ~50-200毫秒 | 取决于集合大小 |
| 元数据过滤 | ~10-50毫秒 | 适当的索引下速度很快 |
