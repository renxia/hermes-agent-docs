...
改编自 [anthropics/financial-services](https://github.com/anthropics/financial-services) 中 Anthropic 的 `pptx-author` 和 `pitch-deck` 技能。原版中的 MCP / Office-JS 分支已被移除——本技能假定使用无头 Python 环境。
...
- 非金融幻灯片（季度全体会议、营销演示文稿）——使用更广泛的 `powerpoint` 技能。
- 包含大量动画、过渡或演讲者备注的演示文稿——使用更广泛的 `powerpoint` 技能。
