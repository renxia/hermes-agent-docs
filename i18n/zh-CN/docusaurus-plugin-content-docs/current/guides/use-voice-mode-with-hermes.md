...
description: "在命令行界面、Telegram、Discord 及 Discord 语音频道中设置和使用 Hermes 语音模式的实用指南"
---

# 在 Hermes 中使用语音模式

本指南是[语音模式功能参考](/user-guide/features/voice-mode)的实践配套手册。

如果说功能页面解释了语音模式能做什么，那么本指南将展示如何真正用好它。

:::tip
[Nous 门户](/integrations/nous-portal)通过单一 OAuth 集成了 LLM 和 TTS——语音模式可以端到端工作，无需额外凭证。
:::
...
| 模式 | 最适合于 | 平台 |
|---|---|---|
| 交互式麦克风循环 | 编码或研究时的个人免提使用 | 命令行界面 |
| 聊天中的语音回复 | 在正常消息旁获得语音回复 | Telegram, Discord |
| 实时语音频道机器人 | 语音频道中的小组或个人实时对话 | Discord 语音频道 |
